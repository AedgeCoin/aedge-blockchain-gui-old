...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of aedge', () => {
      const result = units.getUnit('aedge');
    ...
    it('gets unit of aedge using alias', () => {
      const result = units.getUnit('ae');
  ...
  describe('#getDisplay', () => {
    it('gets display of aedge', () => {
      const result = units.getDisplay('aedge');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('aedge', 9);

      const result = units.getUnit('aedge');

      expect(result).toEqual(9);

      units.setUnit('aedge', 1);
    });
  });
  describe('#setDisplay', () => {
