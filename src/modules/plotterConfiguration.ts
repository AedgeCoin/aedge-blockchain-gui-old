...
export const defaultPlotter = (): Plotter => {
  return {
    displayName: "Aedge Proof of Space",
    options: optionsForPlotter(PlotterName.AEDGEPOS),
    defaults: defaultsForPlotter(PlotterName.AEDGEPOS),
...
const initialState: PlotterConfigurationState = {
  availablePlotters: {
    [PlotterName.AEDGEPOS]: defaultPlotter(),
  },
