...
import { /* mojo_to_aedge_string, */ aedge_to_mojo } from '../../../util/aedge';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_aedge_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of aedge in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Aedge that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Aedge that you have just spent but is not
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      openDialog(
        <AlertDialog>
          <Trans>
            Error: Cannot send aedge to coloured address. Please enter a aedge
            address.
          </Trans>
        </AlertDialog>,
      );
    ...
    if (address.slice(0, 12) === 'aedge_addr://') {
    ...
    const amountValue = Number.parseFloat(aedge_to_mojo(amount));
    const feeValue = Number.parseFloat(aedge_to_mojo(fee));
