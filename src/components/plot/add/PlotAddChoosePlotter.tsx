...
import { CardStep, Select } from '@aedge/core';
import {
  FormControl,
  FormHelperText,
  Grid,
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function displayablePlotters(plotters: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    // Sort aedgepos to the top of the list
    displayablePlotters.sort((a, b) => a == PlotterName.AEDGEPOS ? -1 : a.localeCompare(b));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Aedge Proof of Space plotter. If unsure,
            use the default Aedge Proof of Space plotter.
        </Trans>
      </Typography>
