...
export const aedgeposOptions: PlotterOptions = {
...
export const aedgeposDefaults: PlotterDefaults = {
  plotterName: PlotterName.AEDGEPOS,
  plotSize: 32,
  numThreads: 2,
  numBuckets: 128,
  madmaxNumBucketsPhase3: undefined,
...
export const optionsForPlotter = (plotterName: PlotterName): PlotterOptions => {
  switch (plotterName) {
    ...
    case PlotterName.AEDGEPOS: // fallthrough
    default:
      return aedgeposOptions;
  }
};
